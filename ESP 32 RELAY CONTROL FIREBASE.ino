...
const char* ssid = "ScnPh";
const char* password = "kanudahnyambung";
...
void setup() {
  ...
  konekWifi();
  Firebase.begin("https://esp32-relaycontrol-firebase-default-rtdb.firebaseio.com", "ybELyOWqAeqZgHj5sS4uZF3iHSWvOOUEr61fCeKx");
...
void loop() {
  if (Firebase.getString(firebaseData, "/RelayControl/nilai")) { //misal database diberikan nama relay1
